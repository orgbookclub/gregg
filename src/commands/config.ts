...
import { handleSetReaderRole } from "./subcommands/config";

const handlers: Record<string, CommandHandler> = {
  setreaderrole: handleSetReaderRole,
};

const configSetReaderRoleSubcommand = new SlashCommandSubcommandBuilder()
...
export const config: Command = {
  data: new SlashCommandBuilder()
    ...
    .addSubcommand(configSetReaderRoleSubcommand)
